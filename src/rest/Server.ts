...
export default class Server {
	...
	private registerRoutes(): void {
		...
		this.express.get("/datasets", async (req, res) => {
			await this.sectionHandler.listDatasets(req, res);
		});

		this.express.put("/dataset/:id/:kind", async (req, res) => {
			await this.sectionHandler.addDataset(req, res);
		});

		this.express.delete("/dataset/:id", async (req, res) => {
			await this.sectionHandler.removeDataset(req, res);
		});

		this.express.post("/query", async (req, res) => {
			await this.sectionHandler.queryDataset(req, res);
		});
	}
}
